                ...
                <form id="edit-movie-form" action="<?= $BASE_URL ?>movie_process.php" method="POST"
                    ...
                    <div class="form-group position">
                        ...
                        <input type="text" name="title" class="form-control" id="title"
                            placeholder="Digite o titulo do seu filme" value="<?= $movie->title ?>">
                    </div>
                    <div class="form-group position">
                    ...
                    <div class="form-group position">
                        ...
                        <select name="category" id="category" class="form-control">
                            ...
                            <option value="Ficção" <?= $movie->category === "Ficção" ? "selected" : "" ?>>Ficção
                            </option>
                    ...
                    <div class="form-group position">
                        ...
                        <input type="text" class="form-control" id="trailer" name="trailer"
                            placeholder="Insira o link do seu trailer" value="<?= $movie->trailer ?>">
                    </div>
                    <div class=" form-group position">
                    ...
                    <input type="submit" class="card-btn" value="Editar filme">
