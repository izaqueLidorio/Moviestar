...
class MovieDao implements MovieDAOInterface
{
    ...
    // busca um filme pelo titulo do filme
    ...
    public function create(Movie $movie)
    {
        ...
        //redireciona usuario apor adicionar filme
    ...
    // função  para deletar um filme/ sendo chamada em movie process
